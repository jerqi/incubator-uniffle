...
# TODO: add assembly module to add odfs package
cp "${RSS_HOME}/tencent-bin/ozone-dfs-client2-shaded-1.0.6-jar-with-dependencies.jar" ${CLIENT_JAR_DIR}

cp -r bin $DISTDIR
cp -r conf $DISTDIR
cp -r tencent-bin $DISTDIR
rm $DISTDIR/tencent-bin/*.jar
rm $DISTDIR/"$0"
